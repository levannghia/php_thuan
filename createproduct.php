...
//Luu xuong db
//$photostr = implode(',', $_FILES['productPhoto']['name']);
...
<body>
    <div class="container">
        ...
        <form action="createproduct.php" method="post"enctype="multipart/form-data" id="formUpload">
            ...
            <div class="form-group">
                ...
                <input multiple type="file" name="productPhoto[]" id="productPhoto" class="form-control" aria-describedby="helpId">
            </div>
